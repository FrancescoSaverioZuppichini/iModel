...
parser.add_argument('--checkpoint', help='Store the model2 every epoch', default=True, type=bool)
parser.add_argument('--train', help='Train the model2', default=True, type=bool)
parser.add_argument('--generate', help='Generate text', default=False, type=bool)
parser.add_argument('--from_model', help='The saved model2 you want to use', default='../checkpoints/shakespeare', type=str)
